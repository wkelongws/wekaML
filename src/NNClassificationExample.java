...
public class NNClassificationExample {
    ...
    public static void runKaggleDigitsClassification(boolean useConvolution) throws Exception {
        ...
        int headerRows = 1;
        char separator = ',';
        Matrix data = MatrixUtils.readCSV("/Users/Shuo/Downloads/train.csv", separator, headerRows);
    ...
    public static void runKaggleTitanicClassification() throws Exception {
        ...
        int headerRows = 1;
        char separator = ',';
        Matrix data = MatrixUtils.readCSV("C:/Users/shuowang/Desktop/Kaggle_Titanic_Cleaned.csv", separator, headerRows);
